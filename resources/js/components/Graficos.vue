...
<div class="container col-11">
  ...
  <div class="donut-chart-block block"> 
                    <h1 class="titular">VISÃO GERAL DE TICKETS</h1>
 ...
 <!-- FIN AÑADIDO GRÄFICO -->
                            <p class="center-date">JUNHO<br><span class="scnd-font-color"></span></p>        
                    </div>
                    <ul class="os-percentages horizontal-list">
                        <li>
                            <p class="ios os scnd-font-color">Aberto</p>
                            <p class="os-percentage">2<sup>%</sup></p>
                        </li>
                        <li>
                            <p class="mac os scnd-font-color">Fechado</p>
                            <!-- <p class="os-percentage">3<sup>%</sup></p> -->
                        </li>
                        <li>
                            <p class="linux os scnd-font-color">Cancelado</p>
                            <!-- <p class="os-percentage">9<sup>%</sup></p> -->
                        </li>
                        <li>
                            <p class="win os scnd-font-color">Pedente</p>
               ...
               <span data-valor='5'>   
                 ...
                 <span data-valor='12'>
                    ...
                    <ul class="time-lenght horizontal-list">
                        ...
                        <li><a class="time-lenght-btn" href="#15">Mês</a></li>
                        <li><a class="time-lenght-btn" href="#16">2022</a></li>
                    </ul>
                    <ul class="month-data clear">
                        <li>
                            <p>ABRIL<span class="scnd-font-color"> 2020</span></p>
                            <p><span class="entypo-plus increment"> </span>21<sup>%</sup></p>
                        </li>
                        <li>
                            <p>MAIO<span class="scnd-font-color"> 20201</span></p>
                            <p><span class="entypo-plus increment"> </span>48<sup>%</sup></p>
                        </li>
                        
                        <li>
                            <p>JUNHO<span class="scnd-font-color"> 2022</span></p>
                            <p><span class="entypo-plus increment"> </span>85<sup>%</sup></p>
                        </li>
                    </ul>
...
<p>
  ...
  <div class="bar-chart-block block">
    <h2 class='titular'>Funcionario <span>Do Mês</span></h2>
    <div class='grafico bar-chart'>
       ...
       <ul class='eje-x'>
         <li data-ejeX='37'><i>Baptista</i></li>
         <li data-ejeX='56'><i>Artur</i></li>
         <li data-ejeX='25'><i>Eyala</i></li>
         <li data-ejeX='18'><i>Silvestre</i></li>
         <li data-ejeX='45'><i>Rita</i></li>
         <li data-ejeX='50'><i>Costa</i></li>
         <li data-ejeX='33'><i>Natalia</i></li>
       </ul>
...
************************/
@import url(https://codepen.io/jlalovi/details/bIyAr); 
