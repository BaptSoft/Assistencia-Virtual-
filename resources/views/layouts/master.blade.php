...
<div class="wrapper" id="app">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <router-link to="/dashboard" class="brand-link">
      <img src="{{ asset('/images/logo.png') }}" alt="The Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light">Helpdisk</span>
    </router-link>
  ...
  <footer class="main-footer">
    ...
    {{-- Default to the left --}}
    <strong>Copyright &copy; 2022<a href="https://Ramossoft.com">RAMOSSOFT</a>.</strong> Todos Direictos Reservado..
  </footer>
</div>
{{-- ./wrapper --}}
